...
public class RefreshDatabase extends Worker {
    ...
    public Result doWork() {
        ...
        // Work-Manager ne yapacağını bu metodun altına yazıyoruz.

        // Bize bir girdi verielcek ve onu alamamızı sağlayan bir metotdur
    ...
    private void refreshDatabase(int myNumber){
        ...
        SharedPreferences sharedPreferences = myContext.getSharedPreferences("com.fburaky.workmanager",Context.MODE_PRIVATE);
