...
public class FruitNinja extends ApplicationAdapter implements InputProcessor {
	...
	public void create () {
		...
		// setInputProcessor dediğimiz de kullanıcının verdiği kullanıcıyı girdi olarak alacak .
		// Bu yüzden this yazıyoruz .
	...
	public void render () {
		...
		// Güncel Saniyeyi Milisaniye olarak alıyoruz .
		double newTime = TimeUtils.millis()/1000.0;
		System.out.println("newTİme : " + newTime);
		...
		// Yukarıda telefonun donanımsal yapısına göre bir frameTime hesaplıyoruz
		// Belirlediğimiz bu zamanlama ilede objelerimizi üreteceğiz .
		...
		if(lives > 0){
			...
			for(int i = 0 ; i < lives ; i++){
				batch.draw(apple ,i*50f + 40f, Gdx.graphics.getHeight()- 50f , 40f, 40f);
			}
		...
		font.draw(batch,"Score : " + score , 60,65);
